...
<head>
<meta charset="UTF-8">
<title>Update the Student Mark</title>
	...
	<header>
        ...
        <main>
            <form action ="Update" method="post">
                <label>Enter the Student Rollnumber do you want to Update the Details:</label>
                <input type ="Number" name="rollnumber" class="empty" required>
